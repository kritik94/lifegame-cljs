...
var G__24947 = jsprops;
(G__24947["defaultValue"] = value);

(G__24947["onChange"] = ((function (G__24947,v,value,on_change){
return (function (p1__24946_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24946_SHARP_);
});})(G__24947,v,value,on_change))
);
...
var vec__24950 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24950,(0),null);
var id = cljs.core.nth.call(null,vec__24950,(1),null);
var class$ = cljs.core.nth.call(null,vec__24950,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___24954 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___24954 == null)){
} else {
var key_24955 = temp__5461__auto___24954;
(jsprops["key"] = key_24955);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__24956 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__24956["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24959){
var G__24960 = cljs.core.first.call(null,seq24959);
var seq24959__$1 = cljs.core.next.call(null,seq24959);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24960,seq24959__$1);
});
...
break;
default:
var G__24966 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24966;
continue;
...
var n__4376__auto___24968 = a.length;
var i_24969 = (0);
while(true){
if((i_24969 < n__4376__auto___24968)){
(a[i_24969] = reagent.impl.template.as_element.call(null,(a[i_24969])));

var G__24970 = (i_24969 + (1));
i_24969 = G__24970;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___24971 = a.length;
var i_24972 = (0);
while(true){
if((i_24972 < n__4376__auto___24971)){
var val_24973 = (a[i_24972]);
if(((cljs.core.vector_QMARK_.call(null,val_24973)) && ((reagent.impl.template.key_from_vec.call(null,val_24973) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_24972] = reagent.impl.template.as_element.call(null,val_24973));
...
var ctx = ({});
var vec__24975 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24975,(0),null);
var derefed = cljs.core.nth.call(null,vec__24975,(1),null);
...
var G__24978 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24978) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24978){
...
//# sourceMappingURL=template.js.map?rel=1522854610526
