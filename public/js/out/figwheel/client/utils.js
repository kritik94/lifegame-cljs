...
return (new CustomEvent(event_name,(function (){var obj28849 = {"detail":data};
return obj28849;
})()));
} else {
...
var f = (function (){var pred__28856 = cljs.core._EQ_;
var expr__28857 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28856.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28857))){
return ((function (pred__28856,expr__28857){
return (function (p1__28850_SHARP_){
return console.warn(p1__28850_SHARP_);
});
;})(pred__28856,expr__28857))
} else {
if(cljs.core.truth_(pred__28856.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28857))){
return ((function (pred__28856,expr__28857){
return (function (p1__28851_SHARP_){
return console.debug(p1__28851_SHARP_);
});
;})(pred__28856,expr__28857))
} else {
if(cljs.core.truth_(pred__28856.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28857))){
return ((function (pred__28856,expr__28857){
return (function (p1__28852_SHARP_){
return console.error(p1__28852_SHARP_);
});
;})(pred__28856,expr__28857))
} else {
return ((function (pred__28856,expr__28857){
return (function (p1__28853_SHARP_){
return console.log(p1__28853_SHARP_);
});
;})(pred__28856,expr__28857))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28860){
...
var opts = map__28861__$1;
var eval_fn = cljs.core.get.call(null,map__28861__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28863_SHARP_);
});})(new_def))
);
...
return (function (p__28864){
var vec__28865 = p__28864;
var ky = cljs.core.nth.call(null,vec__28865,(0),null);
var v = cljs.core.nth.call(null,vec__28865,(1),null);
...
}catch (e28870){if((e28870 instanceof Error)){
var e = e28870;
return not_found;
} else {
throw e28870;
...
//# sourceMappingURL=utils.js.map?rel=1522854615458
