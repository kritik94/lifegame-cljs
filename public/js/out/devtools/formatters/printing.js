...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23974){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23975,G__23976,seq23974__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23980_SHARP_){
return !((cljs.core.meta.call(null,p1__23980_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23981__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23985){var _e__23632__auto__ = e23985;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e23987){var _e__23632__auto__ = e23987;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23989 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23990 = opts;
...
var markup_db = cljs.core.get.call(null,map__23990__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23989;
}});
...
;
var temp__5455__auto___23994 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23994)){
var managed_print_level_23995 = temp__5455__auto___23994;
var _STAR_print_level_STAR_23993_23996 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23995;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23993_23996,managed_print_level_23995,temp__5455__auto___23994,writer,opts,job_fn){
return (function (p1__23992_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23992_SHARP_,null);
});})(_STAR_print_level_STAR_23993_23996,managed_print_level_23995,temp__5455__auto___23994,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23993_23996;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1522854608525
