...
var o23846 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23846["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23847 = temp__5455__auto____$1;
return (o23847["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23625__auto__ = f;
return (o__23625__auto__["toString"]).call(o__23625__auto__);
} else {
return "";
}
}catch (e23848){var _ = e23848;
return "";
}});
...
try{var o__23625__auto___23850 = t;
(o__23625__auto___23850["cljs$lang$ctorPrWriter"]).call(o__23625__auto___23850,t,writer);
}catch (e23849){var __23851 = e23849;
}
...
var char_code = (function (){var o__23625__auto__ = (new String(char$));
return (o__23625__auto__["charCodeAt"]).call(o__23625__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23625__auto__ = String;
return (o__23625__auto__["fromCharCode"]).call(o__23625__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23852 = num_code;
switch (G__23852) {
case (1):
return (185);
...
var o__23625__auto__ = String;
return (o__23625__auto__["fromCharCode"]).call(o__23625__auto__,superscript_code);
});
/**
...
}catch (e23854){var _e__23632__auto__ = e23854;
return false;
}})())){
...
var vec__23855 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23855,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23858 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23858["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23859 = temp__5455__auto____$1;
return (o23859["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23862){
var vec__23863 = p__23862;
var ns_detector = cljs.core.nth.call(null,vec__23863,(0),null);
...
var G__23869 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23870 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23869;
remaining_tokens = G__23870;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23860){
var G__23861 = cljs.core.first.call(null,seq23860);
var seq23860__$1 = cljs.core.next.call(null,seq23860);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23861,seq23860__$1);
});
...
var vec__23874 = cljs.core.split_with.call(null,(function (p1__23873_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23873_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23874,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23874,(1),null);
...
var vec__23877 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23877,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23877,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23880 = cljs.core.rest.call(null,remaining_tokens);
var G__23881 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23880;
name_tokens = G__23881;
continue;
} else {
...
var vec__23884 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23884,(0),null);
var arity = cljs.core.nth.call(null,vec__23884,(1),null);
var vec__23887 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23887,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23887,(1),null);
var vec__23890 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23890,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23890,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23890,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23890,(3),null);
...
var vec__23896 = result;
var munged_ns = cljs.core.nth.call(null,vec__23896,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23896,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23896,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23896,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23896,(4),null);
var arity = cljs.core.nth.call(null,vec__23896,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23900 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23900,(0),null);
var args = cljs.core.nth.call(null,vec__23900,(1),null);
var vec__23903 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23903,(0),null);
var name = cljs.core.nth.call(null,vec__23903,(1),null);
...
var G__23906 = (arity + (1));
var G__23907 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23908){
var vec__23909 = p__23908;
var arity = cljs.core.nth.call(null,vec__23909,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23909,(1),null);
...
return cljs.core.get.call(null,arities,p1__23912_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23913_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23916){
var vec__23917 = p__23916;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23917,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23914){
var G__23915 = cljs.core.first.call(null,seq23914);
var seq23914__$1 = cljs.core.next.call(null,seq23914);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23915,seq23914__$1);
});
...
var G__23923 = arg;
var G__23923__$1 = (((G__23923 instanceof cljs.core.Keyword))?G__23923.fqn:null);
switch (G__23923__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23925__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23925__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23925__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23925__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23926 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23926,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23926,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23926,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23926,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23926,(4),null);
var arity = cljs.core.nth.call(null,vec__23926,(5),null);
...
var o__23625__auto__ = f;
return (o__23625__auto__["getBasis"]).call(o__23625__auto__);
});
/**
...
}catch (e23930){var _e__23632__auto__ = e23930;
...
var G__23931 = (obj[cljs.core.first.call(null,path)]);
var G__23932 = cljs.core.rest.call(null,path);
obj = G__23931;
path = G__23932;
continue;
} else {
...
return (function (accum,p__23933){
var vec__23934 = p__23933;
var bit = cljs.core.nth.call(null,vec__23934,(0),null);
var protocol = cljs.core.nth.call(null,vec__23934,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23937){
var vec__23938 = p__23937;
var ns = cljs.core.nth.call(null,vec__23938,(0),null);
var name = cljs.core.nth.call(null,vec__23938,(1),null);
var selector = cljs.core.nth.call(null,vec__23938,(2),null);
...
return (function (p__23942){
var vec__23943 = p__23942;
var munged_name = cljs.core.nth.call(null,vec__23943,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23943,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23943,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23941_SHARP_){
return (obj[cljs.core.first.call(null,p1__23941_SHARP_)]);
});})(name,sorted_matches,vec__23943,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1522854608267
